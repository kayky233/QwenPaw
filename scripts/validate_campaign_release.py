...
FEATURE_FILES = (
    ...
    "src/qwenpaw/app/routers/research_campaign_github_client.py",
    ...
    "scripts/validate_campaign_release.py",
)

TARGETED_TESTS = (
    "tests/unit/research_ledger/test_existing_change_request.py",
    "tests/unit/research_ledger/test_campaign_api_client_controls.py",
    ...
    "tests/unit/app/routers/test_research_campaign_github_client.py",
    ...
    "tests/unit/app/routers/test_research_services_campaign_order.py",
    "tests/unit/cli/test_campaign_group_extensions.py",
    "tests/unit/cli/test_campaign_revision_cmd.py",
    "tests/unit/test_campaign_release_validation_script.py",
